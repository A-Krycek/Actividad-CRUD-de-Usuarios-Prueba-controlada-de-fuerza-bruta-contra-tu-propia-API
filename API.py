...
usuarios_db = [
    {"id": 10001, "nombre_usuario": "admin", "contrasena": "password123", "email": None, "is_active": True},
...
@app.post("/users")
def crear_usuario(nombre_usuario: str, contrasena: str, email: Optional[str] = None):
